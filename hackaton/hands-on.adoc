...
This is the documentation for the https://github.com/nextflow-io/nf-hack18[Nextflow 2018 Hackaton] for beginners. This project will cover the implementation of a Variant Calling analisys pipeline for RNAseq data based on GATK best practices and using Nextflow as the pipeline framework.
