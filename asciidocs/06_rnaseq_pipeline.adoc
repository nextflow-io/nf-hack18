...
mail {
  ...
  smtp.port = 587  
  smtp.user = "AKIAIDY3I32PYKDTFK6A"
  smtp.password = "Aj/Y2fo0s7uo1vs+Ffb+JTLVBw2p5Hk9FRMLvQx5U/+E"
  smtp.auth = true
...
See https://www.nextflow.io/docs/latest/mail.html#mail-configuration[mail documentation] 
for details.
