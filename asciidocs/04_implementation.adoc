...
within the `$HOME/nf-hack18/tutorial` repository directory.
...
from the `$HOME/nf-hack18/tutorial` repository directory with your favourite text editor. In this example we are using `nano`:

[source,cmd]
----
cd $HOME/nf-hack18/tutorial
nano main.nf
----
